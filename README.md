...
| Hotkey | Action |
|--------|---------|
| `Alt + E` | Open Downloads folder (single explorer instance) |
| `Alt + Shift + E` | Open Downloads folder (new explorer instance) |
...
| Hotkey | Action |
|--------|---------|
| `Alt + E` | Open Downloads folder (new explorer instance) |
